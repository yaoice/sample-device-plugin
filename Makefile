...
ROOT_PACKAGE=github.com/yaoice/sample-device-plugin
...
Options:
  ...
  BINS         The binaries to build. Default is sample-device-plugin.
               Example: make image BINS="sample-device-plugin"
  PLATFORMS    The multiple platforms to build. Default is linux_amd64 and linux_arm64.
               This option is available when using: make build.multiarch/image.multiarch/push.multiarch
               Example: make image.multiarch BINS="sample-device-plugin" PLATFORMS="linux_amd64 linux_arm64"
